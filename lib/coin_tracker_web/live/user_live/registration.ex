defmodule CoinTrackerWeb.UserLive.Registration do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="mx-auto max-w-md">
        <div class="text-center mb-8">
          <h1 class="text-2xl font-bold text-zinc-900 dark:text-white">Register for an account</h1>
        ...
        <.form for={@form} id="registration_form" phx-submit="save" phx-change="validate">
          <.input
            ...
            description="We'll send you a magic link to log in"
            required
  ...
  def mount(_params, _session, %{assigns: %{current_scope: %{user: user}}} = socket)
    ...
    {:ok, redirect(socket, to: CoinTrackerWeb.UserAuth.signed_in_path(socket))}
  end
